...
registroAlunosAcademia[0].treinos = {
  Treino_A: [
    ...
    {
      nome: listaExerciciosPorTipo.Peito.Exercicios[4],
      repeticoes: 10,
      series: 3,
      pausa: 60,
      tempoCadaMovimento: 4,
...
console.log(`Treino do ${registroAlunosAcademia[1].nome}:`);
console.log(registroAlunosAcademia[0].treinos);
...
let calculoTempoTreinoA = (((m1 * r1) * s1)/ 60) + ((p1 * s1) / 60);
...
let calculoTempoTreinoB = (((m2 * r2) * s2)/ 60) + ((p2 * s2) / 60);
...
let calculoTempoTreinoC = (((m3 * r3) * s3)/ 60) + ((p3 * s3) / 60);
// console.log(calculoTempoTreinoC);


console.log(`O treino A do aluno Edilson dura em média ${calculoTempoTreinoA / 60} minutos`);
console.log(`O treino B do aluno Edilson dura em média ${calculoTempoTreinoA / 60} minutos`);
console.log(`O treino C do aluno Edilson dura em média ${calculoTempoTreinoA / 60} minutos`);

console.log(`O treino A do aluno João dura em média ${calculoTempoTreinoA / 60} minutos`);
console.log(`O treino B do aluno João dura em média ${calculoTempoTreinoA / 60} minutos`);
console.log(`O treino C do aluno João dura em média ${calculoTempoTreinoA / 60} minutos`);
